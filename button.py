...
class Button:
    ...
    def click(self, screen, active_color, inactive_color):
...
menu_button = Button(455, 470, 95, 45, 'MENU')
next_button = Button(515, 365, 95, 45, 'NEXT')
retry_button_1 = Button(390, 365, 105, 45, 'RETRY')
retry_button_2 = Button(450, 365, 105, 45, 'RETRY')
...
buy_knife_button = Button(380, 365, 77, 47, 'BUY')
