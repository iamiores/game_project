...
defeat_flag = transform.scale(pygame.image.load('images/defeat.png'), (165, 88))
victory_flag = transform.scale(pygame.image.load('images/victory.png'), (165, 88))
one_star = transform.scale(pygame.image.load('images/star.png'), (55, 50))
skull_killed = transform.scale(pygame.image.load('images/killed.png'), (35, 25))
black_scr = transform.scale(pygame.image.load('images/black_scr.jpg'), (1000, 700))
